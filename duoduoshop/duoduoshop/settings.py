...
WSGI_APPLICATION = 'duoduoshop.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方法
        ...
        'file': {  # 向文件中输出日志
            ...
            'filename': os.path.join(BASE_DIR, 'logs/duoduo.log'),  # 日志文件的位置
...
CORS_ORIGIN_WHITELIST = (
    'http://127.0.0.1:8080',
    'http://localhost:8080',
    'http://www.duoduo.site:8080',
    'http://www.duoduo.site:8000'
)
